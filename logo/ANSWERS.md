1. Нужно ли было впринципе писать свой собственный генератор с фамилиями? Было бы проще использовать генератор из datafaker?
   Писать генератор не надо (если только это не должна быть своя база клиентов), гораздо проще использовать готовое решение, если оно удовлетворяет нашим требованиям.
